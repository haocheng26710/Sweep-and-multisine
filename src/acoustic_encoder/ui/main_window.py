...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        content_layout.addWidget(self.action_stack, 1)

        self.result_box = QGroupBox("执行结果")
        self.result_box.setMaximumHeight(150)
        result_layout = QVBoxLayout(self.result_box)
        self.result_scroll_area = QScrollArea()
        self.result_scroll_area.setObjectName("resultScrollArea")
        ...
        result_content_layout.addWidget(self.next_step_label)
        ...
        content_layout.addWidget(self.result_box, 0)
