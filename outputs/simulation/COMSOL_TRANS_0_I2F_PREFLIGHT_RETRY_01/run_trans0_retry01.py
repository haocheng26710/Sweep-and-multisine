"""TRANS-0 RETRY_01: direct-Java study-tag preflight for TRANS-I2F V1.
...
def run_smoke(client: mph.Client) -> dict[str, Any]:
    model, audit = build_model(client, "ISO_CODED", "N", 7, SMOKE_FREQ, "TRANS0_RETRY01_ISO_CODED_N")
    ...
    path = OUT / "TRANS0_RETRY01_ISO_CODED_N.mph"
    model.save(path)
