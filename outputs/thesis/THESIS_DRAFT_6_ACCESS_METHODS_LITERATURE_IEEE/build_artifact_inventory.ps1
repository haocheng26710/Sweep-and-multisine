...
$packageRelative = 'outputs/thesis/THESIS_DRAFT_6_ACCESS_METHODS_LITERATURE_IEEE'
...
$relativePaths = @(
    ...
    "$packageRelative/THESIS_DRAFT_6_ACCESS_METHODS_LITERATURE_IEEE_EN.pdf",
    "$packageRelative/THESIS_DRAFT_6_ACCESS_METHODS_LITERATURE_IEEE_ZH.pdf",
    "$packageRelative/THESIS_DRAFT_6_ACCESS_METHODS_LITERATURE_IEEE_EN_OVERLEAF.zip",
    "$packageRelative/THESIS_DRAFT_6_ACCESS_METHODS_LITERATURE_IEEE_ZH_OVERLEAF.zip",
    ...
    'docs/thesis/IEEE_BILINGUAL_DRAFT_6_ACCESS_METHODS_LITERATURE.md'
)
...
$inventory = [ordered]@{
    schema_version = '1.0'
    package = 'THESIS_DRAFT_6_ACCESS_METHODS_LITERATURE_IEEE'
    date = '2026-09-01'
    status = 'IEEE_BILINGUAL_DRAFT_6_ACCESS_METHODS_LITERATURE_COMPLETE'
    final_test_read = $false
    new_scientific_runs = 0
    scope = 'existing-evidence data/code availability, appendix compression, common-operator and score-chain clarification, recent-literature classification, bilingual alignment, and IEEE typesetting only'
    formats = [ordered]@{
        english = [ordered]@{
    ...
    matched_structure = [ordered]@{
        body_sections = 9
        appendices = 2
        subsections_including_appendices = 47
        equations = 20
        tables = 15
