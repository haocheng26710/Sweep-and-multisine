...
$packageRelative = 'outputs/thesis/THESIS_DRAFT_4_REVIEWED_IEEE'
...
$relativePaths = @(
    ...
    "$packageRelative/THESIS_DRAFT_4_REVIEWED_IEEE_EN.pdf",
    "$packageRelative/THESIS_DRAFT_4_REVIEWED_IEEE_ZH.pdf",
    "$packageRelative/THESIS_DRAFT_4_REVIEWED_IEEE_EN_OVERLEAF.zip",
    "$packageRelative/THESIS_DRAFT_4_REVIEWED_IEEE_ZH_OVERLEAF.zip",
    ...
    'docs/thesis/IEEE_BILINGUAL_DRAFT_4_REVIEWED.md'
)
...
$inventory = [ordered]@{
    schema_version = '1.0'
    package = 'THESIS_DRAFT_4_REVIEWED_IEEE'
    date = '2026-08-31'
    status = 'IEEE_BILINGUAL_DRAFT_4_REVIEWED_COMPLETE'
    final_test_read = $false
    new_scientific_runs = 0
    scope = 'existing-evidence deep editorial review, bilingual alignment, static redraw reuse, and IEEE typesetting only'
    formats = [ordered]@{
        english = [ordered]@{
    ...
    matched_structure = [ordered]@{
        body_sections = 8
        appendices = 2
        subsections_including_appendices = 52
        equations = 14
        tables = 9
