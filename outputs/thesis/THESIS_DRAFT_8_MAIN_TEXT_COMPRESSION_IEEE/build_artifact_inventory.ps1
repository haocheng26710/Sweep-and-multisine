...
$packageRelative = 'outputs/thesis/THESIS_DRAFT_8_MAIN_TEXT_COMPRESSION_IEEE'
...
$relativePaths = @(
    ...
    "$packageRelative/THESIS_DRAFT_8_MAIN_TEXT_COMPRESSION_IEEE_EN.pdf",
    "$packageRelative/THESIS_DRAFT_8_MAIN_TEXT_COMPRESSION_IEEE_ZH.pdf",
    "$packageRelative/THESIS_DRAFT_8_MAIN_TEXT_COMPRESSION_IEEE_EN_OVERLEAF.zip",
    "$packageRelative/THESIS_DRAFT_8_MAIN_TEXT_COMPRESSION_IEEE_ZH_OVERLEAF.zip",
    ...
    'docs/thesis/IEEE_BILINGUAL_DRAFT_8_MAIN_TEXT_COMPRESSION.md'
)
...
$inventory = [ordered]@{
    schema_version = '1.0'
    package = 'THESIS_DRAFT_8_MAIN_TEXT_COMPRESSION_IEEE'
    date = '2026-09-01'
    status = 'IEEE_BILINGUAL_DRAFT_8_MAIN_TEXT_COMPRESSION_COMPLETE'
    final_test_read = $false
    new_scientific_runs = 0
    scope = 'main-text compression, appendix relocation, Table V reflow, bilingual alignment, and IEEE typesetting only; all decisive evidence and claim boundaries retained'
    formats = [ordered]@{
        english = [ordered]@{
        ...
        chinese = [ordered]@{
            ...
            pages = 15
            main_text_pages = 8
            appendix_a_starts_on_page = 9
        }
    }
    matched_structure = [ordered]@{
        body_sections = 9
        appendices = 2
        subsections_including_appendices = 45
        equations = 20
        tables = 15
