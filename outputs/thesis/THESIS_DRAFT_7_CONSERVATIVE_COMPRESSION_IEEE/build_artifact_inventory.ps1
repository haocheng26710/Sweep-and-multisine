...
$packageRelative = 'outputs/thesis/THESIS_DRAFT_7_CONSERVATIVE_COMPRESSION_IEEE'
...
$relativePaths = @(
    ...
    "$packageRelative/THESIS_DRAFT_7_CONSERVATIVE_COMPRESSION_IEEE_EN.pdf",
    "$packageRelative/THESIS_DRAFT_7_CONSERVATIVE_COMPRESSION_IEEE_ZH.pdf",
    "$packageRelative/THESIS_DRAFT_7_CONSERVATIVE_COMPRESSION_IEEE_EN_OVERLEAF.zip",
    "$packageRelative/THESIS_DRAFT_7_CONSERVATIVE_COMPRESSION_IEEE_ZH_OVERLEAF.zip",
    ...
    'docs/thesis/IEEE_BILINGUAL_DRAFT_7_CONSERVATIVE_COMPRESSION.md'
)
...
$inventory = [ordered]@{
    schema_version = '1.0'
    package = 'THESIS_DRAFT_7_CONSERVATIVE_COMPRESSION_IEEE'
    date = '2026-09-01'
    status = 'IEEE_BILINGUAL_DRAFT_7_CONSERVATIVE_COMPRESSION_COMPLETE'
    final_test_read = $false
    new_scientific_runs = 0
    scope = 'author-confirmed physical metadata integration, conservative prose compression, bilingual alignment, and IEEE typesetting only; all scientific evidence and claim boundaries retained'
    formats = [ordered]@{
        english = [ordered]@{
