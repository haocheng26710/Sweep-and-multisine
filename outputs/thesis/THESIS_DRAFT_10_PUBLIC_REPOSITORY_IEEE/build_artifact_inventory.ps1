...
$packageRelative = 'outputs/thesis/THESIS_DRAFT_10_PUBLIC_REPOSITORY_IEEE'
...
$relativePaths = @(
    ...
    "$packageRelative/THESIS_DRAFT_10_PUBLIC_REPOSITORY_IEEE_EN.pdf",
    "$packageRelative/THESIS_DRAFT_10_PUBLIC_REPOSITORY_IEEE_ZH.pdf",
    "$packageRelative/THESIS_DRAFT_10_PUBLIC_REPOSITORY_IEEE_EN_OVERLEAF.zip",
    "$packageRelative/THESIS_DRAFT_10_PUBLIC_REPOSITORY_IEEE_ZH_OVERLEAF.zip",
    ...
    'docs/thesis/IEEE_BILINGUAL_DRAFT_10_PUBLIC_REPOSITORY.md'
)
...
$inventory = [ordered]@{
    schema_version = '1.0'
    package = 'THESIS_DRAFT_10_PUBLIC_REPOSITORY_IEEE'
    date = '2026-09-01'
    status = 'IEEE_BILINGUAL_DRAFT_10_PUBLIC_REPOSITORY_COMPLETE'
    final_test_read = $false
    new_scientific_runs = 0
    scope = 'public GitHub reproducibility binding, bilingual data/code availability update, and IEEE compilation only; Draft 9 scientific narrative, evidence, and claim boundaries retained'
    formats = [ordered]@{
        english = [ordered]@{
