...
def _add_end_socket(body: cq.Workplane, x_face: float, direction: int,
    ...
    ear_x = x_face + direction * 1.0
    ear = box_centered(2.0, 16.0, 3.0, (ear_x, y_center, 5.6))
...
def _add_split_male(body: cq.Workplane, x_face: float,
    ...
    ear = box_centered(3.0, 16.0, 3.0, (x_face - 2.0, y_center, 6.1))
...
def _add_split_socket(body: cq.Workplane, x_face: float,
    ...
    ear = box_centered(3.0, 16.0, 3.0, (x_face + p.JOINT_LOCAL_COLLAR_LENGTH - 1.5,
                                        y_center, 6.1))
