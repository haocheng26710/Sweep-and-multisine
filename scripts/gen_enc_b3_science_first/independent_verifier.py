...
def verify(repo: Path, staging: Path, run_id: str):
    ...
    if index["member_count"] != 20 or index["family_count"] != 4 or index["run_id"] != run_id or index["batch_id"] != "B3":
    ...
    return {
        ...
        "record_kind": "INDEPENDENT_B3_EXACT20_VERIFICATION",
        "task_id": TASK, "run_id": run_id, "batch_id": "B3", "verdict": "PASS",
